...
import { ChefHat, Mail, ArrowRight, Loader2, AlertCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-neutral-950 flex items-center justify-center px-4 py-28">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-neutral-400">Sign in to your Saffron Kitchen account</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-neutral-400">
          ...
          <Link to="/register" className="text-orange-400 hover:text-orange-500 font-medium transition-colors">
            Create one
          </Link>
        </p>
      </div>
